...
const TARGETS = {
    "Next.js Application": "http://localhost:3000/form-validation",
    "Blazor WASM Application": "http://localhost:5000/form-validation"
};

async function main() {
    const folderName = 'form-validation-test';
    const summaryFileName = 'summary_form-validation-test.csv';
