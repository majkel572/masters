...
const TARGETS = {
    "Next.js Application": "http://localhost:3000/third-party-script",
    "Blazor WASM Application": "http://localhost:5000/third-party-script"
};

async function main() {
    const folderName = 'third-party-script-test';
    const summaryFileName = 'summary_third-party-script-test.csv';
