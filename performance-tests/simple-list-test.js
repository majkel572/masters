...
const TARGETS = {
    "Next.js Application": "http://localhost:3000/simple-list",
    "Blazor WASM Application": "http://localhost:5000/simple-list"
};

async function main() {
    const folderName = 'simple-list-test';
    const summaryFileName = 'summary_simple-list-test.csv';
