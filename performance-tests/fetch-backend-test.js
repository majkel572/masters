...
const TARGETS = {
    "Next.js Application": "http://localhost:3000/fetch-backend",
    "Blazor WASM Application": "http://localhost:5000/fetch-backend"
};

async function main() {
    const folderName = 'fetch-backend-test';
    const summaryFileName = 'summary_fetch-backend-test.csv';
