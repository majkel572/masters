...
const TARGETS = {
    "Next.js Application": "http://localhost:3000/static-image",
    "Blazor WASM Application": "http://localhost:5000/static-image"
};

async function main() {
    const folderName = 'static-image-test';
    const summaryFileName = 'summary_static-image-test.csv';
