...
const TARGETS = {
    "Next.js Application": "http://localhost:3000/complex-list",
    "Blazor WASM Application": "http://localhost:5000/complex-list"
};

async function main() {
    const folderName = 'complex-list-test';
    const summaryFileName = 'summary_complex-list-test.csv';
